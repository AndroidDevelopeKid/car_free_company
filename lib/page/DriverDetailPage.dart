                        ...
                        <TableRow>[
                          ...
                          TableRow(
                              children: <Widget>[
                                ...
                                Text(snapshot.data.certificateEndDate == "null" ? "无" : model.certificateEndDate.substring(0,10), style: CustomConstant.normalTextBlack),
                              ]
                          ),
                          TableRow(
                              children: <Widget>[
                          ...
                          TableRow(
                              children: <Widget>[
                                ...
                                Text(snapshot.data.dlCertificateEndDate == "null" ? "无" : model.dlCertificateEndDate.toString().substring(0,10), style: CustomConstant.normalTextBlack),
                              ]
                          ),
                        ],
                      ),
